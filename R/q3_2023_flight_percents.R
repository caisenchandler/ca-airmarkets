...
library(tidyverse)
coupons_q3_2023 <- read_csv("C:\\Users\\eilis\\OneDrive\\Documents\\UCDavis\\HSR\\Data\\Flights\\DB1B\\DB1B_Q3_2023\\q3_2023_coupon.zip")
market_q3_2023 <- read_csv("C:\\Users\\eilis\\OneDrive\\Documents\\UCDavis\\HSR\\Data\\Flights\\DB1B\\DB1B_Q3_2023\\q3_2023_market.zip")
...
CA_airports_pass_flow_q3_2023 <- airport_pairs %>%
  pmap_dfr(~ process_airport_pair(..1, ..2)) %>% 
  arrange(desc(total_passengers))

#Print the results. 
print(CA_airports_pass_flow_q3_2023)
view(CA_airports_pass_flow_q3_2023)
